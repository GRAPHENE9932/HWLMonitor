...
enum key : uint8_t {
    ...
    KEY_UP_ARROW = 0x52,
    KEY_NUM_LOCK = 0x53,
    KEY_NUMPAD_SLASH = 0x54,
    KEY_NUMPAD_ASTERISK = 0x55,
...
enum key_modifier : uint8_t {
    KEYMOD_NONE = 0x00,
    KEYMOD_LEFT_CTRL = 0x01,
    KEYMOD_LEFT_SHIFT = 0x02,
    KEYMOD_LEFT_ALT = 0x04,
    KEYMOD_LEFT_WIN = 0x08,
    KEYMOD_RIGHT_CTRL = 0x10,
    KEYMOD_RIGHT_SHIFT = 0x20,
    KEYMOD_RIGHT_ALT = 0x40,
    KEYMOD_RIGHT_WIN = 0x80,
};
